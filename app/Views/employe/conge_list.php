...
<div class="topbar-actions">
  <a href="<?= site_url('employe/conges/create') ?>" class="btn-forest" style="padding:7px 14px;font-size:.82rem"><i class="bi bi-plus-lg"></i> Nouvelle demande</a>
</div>
<?= $this->endSection() ?>
      ...
      <?php else: ?>
        <?php foreach ($conges as $conge): ?>
          <tr>
            ...
            <td class="td-muted" style="font-size:.78rem"><?= esc($conge['commentaire']) ?></td>
            <td>
