...
<ul class="sidebar-nav">
    ...
    <li><a href="<?= site_url('employe/conges') ?>"><i class="bi bi-plus-circle"></i> Nouvelle demande</a></li>
...
<div class="topbar-actions">
    <a href="<?= site_url('employe/conges') ?>" class="btn-forest" style="padding:7px 14px;font-size:.82rem">
...
<div class="metrics">
    ...
    <div class="metric">
        ...
        <div class="metric-val"><?= esc($joursRestants ?? 0) ?></div>
...
<div class="data-card">
    ...
    <div style="padding:1rem 1.25rem;font-size:.9rem;color:var(--muted)">
        <a href="<?= site_url('employe/conges') ?>" class="btn-forest" style="padding:7px 14px;font-size:.82rem;text-decoration:none">
            <i class="bi bi-send"></i> Soumettre une demande
        </a>
    </div>
</div>
<?= $this->endSection() ?>
